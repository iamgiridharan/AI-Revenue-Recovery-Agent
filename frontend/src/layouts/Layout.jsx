...
const navItems = [
  ...
  { path: '/cases', label: 'Revenue Risk Cases', icon: (
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-gray-900 text-white flex flex-col transform transition-transform duration-200 ease-in-out ${
      ...
      >
        <div className="p-5 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold">Revenue Recovery</h1>
              <p className="text-[10px] text-gray-400 uppercase tracking-wider">AI Agent Dashboard</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <span className="px-2 py-1 bg-amber-50 text-amber-700 rounded-full border border-amber-200 font-medium">
              Test Mode
            </span>
          </div>
        </header>
